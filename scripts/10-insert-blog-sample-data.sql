...
INSERT INTO blog_posts (title, slug, excerpt, content, image, category, tags, read_time, published, featured, published_at) VALUES
(
    'Contabilidade para Influencers: Saiba mais!',
    'contabilidade-para-influencers',
    'É influenciador ou conhece algum? Fique por dentro de todos os detalhes para evitar surpresas fiscais.',
    '# Contabilidade para Influencers: Saiba mais!
...
**Precisa de ajuda com sua contabilidade digital?** Entre em contato conosco e descubra como podemos simplificar sua vida fiscal!',
    '/images/influencer-accounting.png',
    'Tributação',
    ARRAY['influencers', 'tributação', 'mei', 'pessoa jurídica'],
    8,
    true,
    true,
    NOW() - INTERVAL '5 days'
...
(
    ...
    'irpf-2025-guia-completo',
    'Março chegou, saiba todos os detalhes para fazer a sua declaração de imposto de renda.',
    '# IRPF 2025: Tudo o que você precisa saber!
...
**Precisa de ajuda com sua declaração?** A ON4 está aqui para simplificar sua vida fiscal!',
    '/images/tax-lion-2025.png',
    'Imposto de Renda',
    ARRAY['irpf', 'imposto de renda', 'declaração', '2025'],
    12,
    true,
    false,
...
(
    ...
    'mei-2024-guia-completo',
    'Tudo sobre o MEI em 2024: como abrir, obrigações, benefícios e mudanças na legislação.',
    '# MEI 2024: Guia Completo para Microempreendedores
...
**Quer abrir seu MEI ou precisa de ajuda com as obrigações?** A ON4 está aqui para te ajudar!',
    ...
    'MEI',
    ARRAY['mei', 'microempreendedor', 'formalização', '2024'],
    10,
    true,
    false,
