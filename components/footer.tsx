      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          ...
          <div className="flex space-x-4">
            <Link
              href="https://www.youtube.com/channel/UC1DjgKpyqFq5o9hkZXF5USA"
            ...
            <Link
              href="https://facebook.com/on4contabilidade"
              className="bg-gray-600 w-10 h-10 rounded-full flex items-center justify-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <Link
              href="https://www.linkedin.com/company/on4contabilidade/"
              className="bg-gray-600 w-10 h-10 rounded-full flex items-center justify-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
